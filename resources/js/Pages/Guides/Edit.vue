        ...
        <div class="bg-linear-to-br from-wine-600 via-wine-500 to-wine-700 text-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <p class="text-wine-100 text-lg/relaxed">
                    Update your guide content
                </p>
            </div>
        </div>

        <!-- Pending Revision Notice -->
        <div v-if="pendingRevision" class="bg-gold-50 dark:bg-gold-900/20 border-b-2 border-gold-200 dark:border-gold-800">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                <div class="flex items-start gap-3">
                    <svg class="size-6 text-gold-600 dark:text-gold-400 shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                    </svg>
                    <div class="flex-1">
                        <h3 class="font-semibold text-gold-900 dark:text-gold-100 mb-1">
                            Pending Edit Under Review
                        </h3>
                        <p class="text-sm/relaxed text-gold-800 dark:text-gold-200 mb-2">
                            {{ pendingRevision.user.name }} submitted edits {{ pendingRevision.created_at }}. The changes are awaiting moderation approval.
                        </p>
                        <p class="text-xs/relaxed text-gold-700 dark:text-gold-300">
                            <span v-if="isTrustedEditor">As a trusted editor, your changes will be applied immediately.</span>
                            <span v-else>Your submitted changes will be reviewed by moderators before going live.</span>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white dark:bg-pearl-800 rounded-2xl border-2 border-pearl-200 dark:border-pearl-700 p-8">
                        <Form
                            :action="route('guides.update', guide.id)"
                            method="put"
...
const form = ref({
    ...
    difficulty: props.guide.difficulty,
    estimated_minutes: props.guide.estimated_minutes,
    os_tags: props.guide.os_tags || [],
    tldr: props.guide.tldr,
