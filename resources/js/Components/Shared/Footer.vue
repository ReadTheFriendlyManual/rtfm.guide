                            ...
                            <div class="flex gap-3">
                                <div class="flex-1">
                                    <input
                                        ...
                                        :class="{ 'border-wine-500 dark:border-wine-500': errors.email }"
                                    />
                                    <p v-if="errors.email" class="mt-1.5 text-xs/relaxed text-wine-600 dark:text-wine-400 font-medium">
                                        {{ errors.email }}
                                    </p>
                                </div>
                                <button
...
const handleSuccess = () => {
    // Form will auto-reset after success
    // Toast notification will be shown via session flash
}
</script>
